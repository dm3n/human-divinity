...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\itshape Human Divinity}
...
% ─── Metadata ────────────────────────────────────────────────────────────────
\hypersetup{
  pdftitle={Human Divinity — Publication I: The Sacred Secretion (April 2026)},
...
\begin{titlepage}
  ...
  {\LARGE\bfseries Human Divinity}\\[0.8em]
  {\large Publication I: The Sacred Secretion}\\[0.4em]
  {\large A Unified Theory of Biblical Allegory, Neuroanatomy,\\
  and the Hermetic Architecture of the Divine Human}
  \\[0.6em]
  {\normalsize\itshape Publication~I \textbullet\ April 2026}
  ...
  \begin{abstract}
    \noindent
    This paper opens \emph{Human Divinity}, a three-publication thesis by
    Daniel Ray Edgar on the divine capacity encoded in the human body. It
    advances a unified thesis: the canonical narrative of the
    ...
    institutional religion systematically obscured it. Sacred secretion is
    therefore not the title of the whole project but the biological mechanism
    inside the larger doctrine of human divinity.
  \end{abstract}
...
This establishes the foundation of the whole series: Hermeticism gives the
symbolic grammar for the sacred secretion; alchemy gives the transformation
process; Christianity gives the Christ narrative; Jung gives the psychological
interpretation; and the body practice becomes the ritual laboratory. The title
\emph{Human Divinity} names the end of that synthesis. The sacred secretion is
the mechanism. Human divinity is the thesis.
...
\subsection{Hermeticism, Alchemy, and the Grammar of the Divine Human}
...
This matters because Hermeticism is the symbolic grammar of this entire
argument. It supplies the doctrine of the human being as microcosm: the body as
a small cosmos, the cosmos as an expanded body, and the spinal ascent as the
inner version of the world axis. Alchemy then supplies the process. Its
language of base matter, purification, vessel, fire, oil, stone, and gold is
the language of transformation: the lower substance is not rejected, but
refined until it reveals the divine life hidden inside it. Isaac Newton's
private work on alchemy and the \emph{Emerald Tablet} belongs to this lineage
not as an eccentric distraction from science but as evidence that, in the
early modern mind, matter, spirit, scripture, and natural philosophy were not
yet separate domains~\autocite{dobbs1991}.

Christianity gives this alchemical process its narrative form: birth,
temptation, descent, Gethsemane, crucifixion, tomb, resurrection, and ascent.
Jung gives the psychological reading: alchemy is the drama of psychic
integration, the symbolic union of opposites, and the emergence of the Self
from the conflict between conscious and unconscious life~\autocite{jung1968}.
The body practice completes the chain. It turns the symbolic temple into a
ritual laboratory, where continence, purification, meditation, fasting, light,
darkness, and attention become the experimental conditions through which the
Christ process is tested in the practitioner's own nervous system.

This is why the present series is titled \emph{Human Divinity}. The sacred
secretion names the oil. Hermeticism explains why the oil mirrors the cosmos.
Alchemy explains how the oil is refined. Christianity explains why its ascent
is called resurrection. Jung explains what the resurrection does to the psyche.
The human body is the laboratory in which all of these systems become one.

The \emph{Kybalion} (1908), attributed to ``Three Initiates,'' systematises the
